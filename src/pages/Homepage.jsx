...
export default function Homepage() {
  ...
  console.log({ getAllPushNotificationByUser });
        ...
        {getAllPushNotificationByUser.data?.pushNotifications?.map((push) => (
          ...
          >
            ...
            <div className="pt-5 pb-2 flex justify-center">
              <button onClick={()=>TriggerPushNotification(push._id)} className="w-36 h-10 font-semibold rounded-md bg-indigo-100 hover:scale-90 duration-500">
                Trigger
              </button>
            </div>
          </div>
